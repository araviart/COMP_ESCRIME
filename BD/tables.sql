...
ALTER TABLE COMPETITION ADD FOREIGN KEY (idLieu) REFERENCES LIEU(idLieu);
ALTER TABLE COMPETITION ADD FOREIGN KEY (idSaison) REFERENCES SAISON(idSaison);
ALTER TABLE COMPETITION ADD FOREIGN KEY (idCategorie) REFERENCES CATEGORIE(idCategorie);
ALTER TABLE COMPETITION ADD FOREIGN KEY (idClassementProv) REFERENCES CLASSEMENT_PROVISOIRE(idClassementProv);
ALTER TABLE COMPETITION ADD FOREIGN KEY (idClassementFinal) REFERENCES CLASSEMENT_FINAL(idClassementFinal);
ALTER TABLE COMPETITION ADD FOREIGN KEY (idArme) REFERENCES ARMES(idArme);
ALTER TABLE ESCRIMEUR ADD FOREIGN KEY (idCat) REFERENCES CATEGORIE(idCategorie);
ALTER TABLE CATEGORIE ADD FOREIGN KEY (idComp) REFERENCES COMPETITION(idComp);
ALTER TABLE CLASSEMENT_PROVISOIRE ADD FOREIGN KEY (idComp) REFERENCES COMPETITION(idComp);
ALTER TABLE TIREUR ADD FOREIGN KEY (idE) REFERENCES ESCRIMEUR(idEscrimeur);
ALTER TABLE TIREUR ADD FOREIGN KEY (idClub) REFERENCES CLUB(idClub);
ALTER TABLE ARBITRE ADD FOREIGN KEY (idE) REFERENCES ESCRIMEUR(idEscrimeur);
ALTER TABLE MATCH ADD FOREIGN KEY (idTypeMatch) REFERENCES TYPE_MATCH(idTypeMatch);
ALTER TABLE MATCH ADD FOREIGN KEY (idArbitre) REFERENCES ARBITRE(idArbitre);
ALTER TABLE MATCH ADD FOREIGN KEY (idTireur1) REFERENCES TIREUR(idTireur);
ALTER TABLE MATCH ADD FOREIGN KEY (idTireur2) REFERENCES TIREUR(idTireur);
ALTER TABLE RESULTAT_MATCH ADD FOREIGN KEY (idMatch) REFERENCES MATCH(idMatch);
ALTER TABLE RESULTAT_MATCH ADD FOREIGN KEY (idFeuille) REFERENCES FEUILLE_MATCH(idFeuille);
ALTER TABLE POULE ADD FOREIGN KEY (idFeuille) REFERENCES FEUILLE_MATCH(idFeuille);